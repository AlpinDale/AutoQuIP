...
NVCC_FLAGS = ["-O3", "-g", "-Xcompiler", "-rdynamic", "-lineinfo"]
...
CXX_FLAGS += ["-D_GLIBCXX_USE_CXX11_ABI={ABI}"]
NVCC_FLAGS += ["-D_GLIBCXX_USE_CXX11_ABI={ABI}"]
...
auto_gptq_extension_sources = [
    "kernels/quiptools_wrapper.cpp",
    "kernels/e8p_gemv.cu",
    "kernels/origin_order.cu"
]

auto_gptq_extension = cpp_extension.CUDAExtension(
    name="quiptools_cuda",
    sources=auto_gptq_extension_sources,
    extra_compile_args={
        "cxx": CXX_FLAGS,
        "nvcc": NVCC_FLAGS,
    },
)
ext_modules.append(auto_gptq_extension)
...
def get_auto_gptq_version() -> str:
    version = find_version(get_path("auto_quip", "__init__.py"))
...
setup(
    ...
    author='AlpinDale',
    license="AGPL 3.0",
    description="Easy QuIP# quantization",
    long_description=read_readme(),
    long_description_content_type="text/markdown",
    url="https://github.com/AlpinDale/auto_quip",
    packages=find_packages(exclude=("kernels")),
